...
public class Operator {
   ...
   private String op_real_name;     //姓名
   private String op_institute;     //所属机构
   private String op_role;          //角色
   private String op_gender;        //性别
   private String op_email;         //邮箱
   private String op_phone;         //手机
   private String op_status;        //帐号状态
   ...
   public String getOp_institute() {
      return op_institute;
   }

   public void setOp_institute(String op_institute) {
      this.op_institute = op_institute;
   }
