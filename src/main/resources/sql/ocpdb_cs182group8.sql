...
(
    op_user_name varchar(20) NOT NULL PRIMARY KEY,                       #用户名
    ...
    op_status    int(1) default 1 check (op_status = 0 or op_status = 1) #状态（启用/禁用）
) engine = InnoDB
  default charset = UTF8;
# 插入运营人员信息表测试数据
insert into operator(op_user_name, op_real_name, op_institute, op_role, op_gender, op_email, op_phone, op_status)
values ('operator1', '姓名1', '机构1', '角色1', '男', 'operator1@qq.com', '11451411451', '1'),
       ('operator2', '姓名2', '机构2', '角色2', '男', 'operator2@qq.com', '11451411452', '1'),
       ('operator3', '姓名3', '机构3', '角色3', '男', 'operator3@qq.com', '11451411453', '1'),
       ('operator4', '姓名4', '机构4', '角色4', '男', 'operator4@qq.com', '11451411454', '1'),
       ('operator5', '姓名5', '机构5', '角色5', '男', 'operator5@qq.com', '11451411455', '1'),
       ('operator6', '姓名6', '机构6', '角色6', '男', 'operator6@qq.com', '11451411456', '1'),
       ('operator7', '姓名7', '机构7', '角色7', '男', 'operator7@qq.com', '11451411457', '1'),
       ('operator8', '姓名8', '机构8', '角色8', '男', 'operator8@qq.com', '11451411458', '1'),
       ('operator9', '姓名9', '机构9', '角色9', '男', 'operator9@qq.com', '11451411459', '1'),
       ('operator10', '姓名10', '机构10', '角色10', '男', 'operator10@qq.com', '11451411450', '1');


# 创建经销商地址表
create table retailer_address
(
    rta_retailer_id   int(10) NOT NULL, #经销商编码
...
(
    ...
    warehouse_status        int(1) check (warehouse_status = 0 or warehouse_status = 1), #状态（启用/禁用）
...
values (01, '仓库1', 1, '张一', '11451411111', '四川省双流区1', '备注1'),
       (02, '仓库2', 1, '张二', '11451411112', '四川省双流区2', '备注2'),
       (03, '仓库3', 1, '张三', '11451411113', '四川省双流区3', '备注3'),
       (04, '仓库4', 1, '张四', '11451411114', '四川省双流区4', '备注4'),
       (05, '仓库5', 1, '张五', '11451411115', '四川省双流区5', '备注5'),
       (06, '仓库6', 1, '张六', '11451411116', '四川省双流区6', '备注6'),
       (07, '仓库7', 1, '张七', '11451411117', '四川省双流区7', '备注7'),
       (08, '仓库8', 1, '张八', '11451411118', '四川省双流区8', '备注8'),
       (09, '仓库9', 1, '张九', '11451411119', '四川省双流区9', '备注9'),
       (10, '仓库10', 1, '张十', '11451411110', '四川省双流区10', '备注10');
...
(
    rto_transaction_id   varchar(20) NOT NULL PRIMARY KEY, #主键 网上交易订单号
    rto_retailer_id      int(10)     NOT NULL,             #外键 所属经销商编号
    rto_source_website   varchar(50),                      #订单来源网站
    rto_source_store     varchar(50),                      #所属网店名称
    rto_order_status     int(1),                           #订单状态 (0打开,1关闭,2取消,3完成)
    rto_shipment_status  int(1),                           #发货状态 (0待发货,l待收货,2已收货)
...
VALUES ('202012210100', 1, '淘宝', '天下第一店', 0, 1, now(), now(), now(), 100, 100, 20, 0, '成都市人民政府', '金正恩', '110', '东风快递',
        2039393932);


# 创建备货订单产品表
create table stockorder_product
(
    sop_order_id      varchar(20) NOT NULL, #订单编码
    sop_product_id    int(10)     NOT NULL, #产品编码
    sop_product_qty   decimal(8, 2),        #备货数量
    sop_invoice_price decimal(8, 2),        #开票价格
    sop_total_price   decimal(8, 2),        #总金额
    sop_volume        decimal(8, 2),        #总体积
...
# 创建批发订单产品表
create table wholesaleorder_product
(
    wsop_order_id      varchar(20) NOT NULL, #订单编码
    wsop_product_id    int(10)     NOT NULL, #产品编码
    wsop_product_qty   decimal(8, 2),        #备货数量
    wsop_invoice_price decimal(8, 2),        #开票价格
    wsop_total_price   decimal(8, 2),        #总金额
    wsop_volume        decimal(8, 2),        #总体积
